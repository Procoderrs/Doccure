...
export default function Wallet() {
  return (
    <div className="p-6">
      <h2 className="text-2xl font-bold text-gray-900 mb-5">Wallet</h2>

      {/* Stats + Bank */}
      <div className="bg-[#0f172a] rounded-2xl p-6 mb-6 grid grid-cols-2 gap-6">
        <div>
        ...
        <div>
          ...
          <div className="flex gap-3 text-sm">
            <button className="text-[#02bfff] hover:underline">Edit Details</button>
            <span className="text-white/30">|</span>
            <button className="text-[#02bfff] hover:underline">Add Cards</button>
            <span className="text-white/30">|</span>
            <button className="text-[#02bfff] hover:underline">Other Accounts</button>
          </div>
        </div>
      </div>
