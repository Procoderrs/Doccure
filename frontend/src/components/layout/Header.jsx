...
function HeroSection() {
  ...
  return (
    <div className="relative">
      ...
      <section
        className="relative w-full h-full pb-12 lg:pb-48 flex items-center font-user overflow-hidden"
        style={{
      ...
      >
        ...
        <img
          ...
          alt=""
          className="absolute rotate-0 w-[35%] -top-28 opacity-20 right-0 pointer-events-none hidden lg:block"
        />
        <img
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-18 pt-28 lg:pt-0 grid grid-cols-1 lg:grid-cols-[60%_40%] items-center gap-8">
          ...
          <div className="relative hidden lg:flex items-end justify-center">
            ...
            {/* Pulse call widget */}
            <div className="absolute bottom-24 right- z-50">
      ...
      {/* Category Icons — section ke bahar, wrapper ke andar */}
